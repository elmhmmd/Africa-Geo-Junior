...
<body class="bg-gray-100 font-sans">
               ...
               while ($country = $result->fetch_assoc()) {
                ...
                if (isset($countryMap[$countryName])) {
                    ...
                    $flagUrl = "https://flagsapi.com/$code/$style/$size.png";
                     ...
                     $stmtCities->close();
                    echo '</div>';
                    echo '<form method="post" class="add-city-form mt-4">';
                         echo '<input type="hidden" name="id_pays" value="' . $country['id_pays'] . '">';
                           echo  '<button type="button" class="addCityButton bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" data-country-id="' . $country['id_pays'] . '">Add City</button>';
                      echo  '</form>';
                 echo '</div>';
                  echo '</div>';
                  }
  ...
  <script>
    ...
    var addCityButton = document.querySelectorAll(".addCityButton");
   ...
   addCityButton.forEach((addCityBtn) => {
    ...
    document.addEventListener("click", function(event) {
     ...
     document.querySelectorAll("form").forEach(form => {
         form.addEventListener("submit", function(event) {
             cities = [];
            form.querySelectorAll(".city-container").forEach((cityContainer) => {
        ...
        form.querySelector('input[name="cities"]')?.setAttribute('value', JSON.stringify(cities));
      });
     });
    </script>
</body>
